...
var Button1Motion, ButtonMotion, ButtonPress, ButtonRelease, EventEmitter, Exposure, Log, PointerMotion, StructureNotify, SubstructureNotify, X, x11, _,
...
X = (function(_super) {
  ...
  X.prototype.CreateCaptureWindow = function() {
    ...
    this.X.CreateWindow(this.captureWid, this.root, 0, 0, this.display.screen[0].pixel_width, this.display.screen[0].pixel_height, 0, 0, 1, 0, {
